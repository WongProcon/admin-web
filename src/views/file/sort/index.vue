<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sortList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类路径" align="center" prop="url"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="分类路径" prop="url">
          <el-input v-model="form.url" placeholder="请输入分类路径"/>
        </el-form-item>
      </el-form>
...
<script>
import {listSort, getSort, delSort, addSort, updateSort} from "@/api/file/sort";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除文件分类编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('file/sort/export', {
        ...this.queryParams
      }, `file_sort.xlsx`)
    }
  }
